...
public class FindPathFragment extends Fragment {
    ...
    private FindPathViewModel findPathViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        findPathViewModel =
                ViewModelProviders.of(this).get(FindPathViewModel.class);
        View root = inflater.inflate(R.layout.fragment_find_path, container, false);
        final TextView textView = root.findViewById(R.id.text_slideshow);
        findPathViewModel.getText().observe(this, new Observer<String>() {
            @Override
